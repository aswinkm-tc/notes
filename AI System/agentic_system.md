...
1. The Ingestion & Agentic Pipeline
Goal: < 30s latency for data freshness; reliable multi-step agent tasks.
* The Ingestion: Use Kafka/SQS with Tenant-Based Partitioning. This prevents one large customer from delaying the data of another.
* The Execution: Use Durable Execution (Temporal/Step Functions).
...
2. The Model Gateway (10,000 RPS)
...
3. The Semantic Cache & "Cold Start"
...
4. The Preview Environment Engine
